...
const StaffSignUp = () => {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    try {
      const response = await axios.post('http://localhost:8000/Staff/SignUp', volunteer);
      ...
      if (success) {
        ...
        setTimeout(() => {
          navigate('/dashBoard/Staff/SignUp/page');
      }, 2000);
      } else {
  ...
  return (
    <div className="signInContainer">
      ...
      <h2>Sign Up</h2>
        ...
        <input style={{marginLeft:"0 px"}} type="checkbox" id="employee" name="responsibility" value="Employee"/>
